import { InitialStateTypeCatalog } from './../catalog-reducer';
import { CategoryType, ProductBasketType, ProductType, SortValueType } from "../../type/type";
import { InitialStateAppType } from "../app-reducer";
import { InintalStateTypeBasket } from "../basket-reducer";
import { InitialStateCategoryType } from '../category-reducer';
import { InitialStateTypeFilter } from '../filter-reducer';

export let testStateApp: InitialStateAppType = {
    inintialized: false
}

export let testBasketProduct: ProductBasketType = {
...
export let testBasket: Array<ProductBasketType> = [
    testBasketProduct
]

export let testBarcodeProductInBasket = 39510200006;

export let testStateBasket: InintalStateTypeBasket = {
    basket: testBasket
}

export let testProductList: Array<ProductType> = [
        {
            "image_url": "https://drive.google.com/uc?export=view&id=1rtENZ2vlFGhSLO5Qfa4ZVyQflRUJItTz",
            "title": "DEPILTOUCH PROFESSIONAL azulen",
            "type_product": [
...
export let testManufacturerList: { [index: string]: number } = { 'DEPILTOUCH PROFESSIONAL': 1, 'ECOLATIER': 1, 'DR IRENA ERIS': 1 }
export let testSortList: Array<string> = ['Название А-Я', 'Название Я-А', 'По возрастанию цены', 'По убыванию цены']
export let testSort: SortValueType = 'Название А-Я'
export let testStateCatalog: InitialStateTypeCatalog = {
    productList: testProductList,
    manufacturerList: testManufacturerList,
    sortList: testSortList,
    sort: testSort
}
export let testStateCatalogEmpty: InitialStateTypeCatalog = {
    productList: null,
...
export let testCategoryList: Array<CategoryType> =  [
    {
        "id": 1,
...
export let testStateCategory: InitialStateCategoryType = {
    categoryList: testCategoryList
} 

export let testStateCategoryEmpty: InitialStateCategoryType = {
    categoryList: null
} 

export let testStateFilter: InitialStateTypeFilter = {
        category: 'Уход за телом',
...
export let testProduct: ProductType = {
...
export let testProductSameInBasket: ProductType = {
        "image_url": "https://drive.google.com/uc?export=view&id=1rtENZ2vlFGhSLO5Qfa4ZVyQflRUJItTz",
        "title": "DEPILTOUCH PROFESSIONAL azulen",
        "type_product": [
            { "Уход за телом": ["Эпиляция и депиляция"] }
...
export let testChangedProduct: ProductType = {
    "image_url": "https://drive.google.com/uc?export=view&id=1rtENZ2vlFGhSLO5Qfa4ZVyQflRUJItTz",
    "title": "DEPILTOUCH PROFESSIONAL azulen",
    "type_product": [
        { "Уход за телом": ["Эпиляция и депиляция"] }
